...
'use strict';
  ...
  /*jQuery.get('http://localhost/ta-ade/assets/uploads/'+color, function(data) {
      var DEFAULT_URL = data;
  });*/

    /*var DEFAULT_URL = color;*/
    var DAFAULT_URL = './uploads/compressed.tracemonkey-pldi-09.pdf';
...
function configure(PDFJS) {
  ...
  PDFJS.workerSrc = baseURL + 'assets/pdfjs/build/pdf.worker.js';
